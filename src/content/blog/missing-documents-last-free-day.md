---
title: 'Missing Documents and the Last Free Day: Closing the Gap Early'
slug: missing-documents-last-free-day
description: >-
  How missing documents drive last free day risk, and how early detection helps
  teams request paperwork in time to avoid demurrage.
date: '2026-03-29'
topic: Demurrage & Detention
readTime: 13 min read
heroImage:
  src: /images/blog/missing-documents-last-free-day/hero.jpg
  alt: Shipping documents fanned out beside a container photo
  caption: >-
    Last free day risk usually starts before the deadline, in the document
    trail.
  credit: Solomon203
  sourceUrl: 'https://commons.wikimedia.org/wiki/File:FPMC_TEU_shipping_containers.jpg'
  license: CC BY-SA 3.0
inlineImages:
  - src: /images/blog/missing-documents-last-free-day/inline-1.jpg
    alt: Operator checking a document against a deadline
    caption: Catching a missing document early leaves time to request it.
    credit: Rafaell Russell
    sourceUrl: >-
      https://commons.wikimedia.org/wiki/File:Container_yard_in_Port_Of_Chittagong.JPG
    license: CC BY-SA 4.0
diagram:
  src: /diagrams/blog/missing-documents-last-free-day.svg
  alt: >-
    Workflow diagram showing required documents and an approaching last free day
    feeding Zettel early detection that flags a missing document, prompts an
    early request, and clears the shipment before the deadline
  caption: >-
    How early detection of missing documents before the last free day helps
    teams request them in time and avoid demurrage.
sources:
  ...
  - label: eCFR
    url: 'https://www.ecfr.gov/current/title-19/chapter-I/part-142'
  - label: Federal Maritime Commission
    url: >-
...
| Missing or Late Item | What It Can Block | Operational Impact |
| ---------------------------------------- | --------------------------------------------------- | ---------------------------------------------- |
| Delivery order | Carrier or terminal release | Drayage provider may not be able to pick up |
| Arrival notice | Visibility into arrival, charges, and release steps | Team may miss early prep windows |
| Customs release | Legal or procedural cargo release | Container may sit even if physically available |
| Appointment confirmation | Gate pickup execution | Driver may lose slot or need rescheduling |
| Bill of lading mismatch | Document-to-container matching | Team may chase the wrong party or file |
| Invoice or payment proof | Release and finance approval | Payment or release may stall |
| Packing list or commercial invoice issue | Customs or internal validation | Broker may need corrections |
...
| Container | Required Document | Status | Blocker | Next Action |
| ----------- | ------------------------ | ------- | ------------------------------------ | --------------------------------- |
| ABCU1234567 | Delivery order | Missing | Release not confirmed | Request DO from carrier/forwarder |
| XYZU7654321 | Customs release | Pending | Broker waiting on invoice correction | Send corrected commercial invoice |
| TGHU5555555 | Appointment confirmation | Found | No blocker | Share with dray dispatcher |
| MSCU9999999 | Arrival notice | Late | Charges and LFD unclear | Escalate to carrier contact |
...
Is the delivery order present?
Is customs release confirmed?
...
| Readiness Layer | Key Question | Example Signal |
| ------------------- | ------------------------------------------------- | --------------------------------------------------- |
| Document readiness | Do we have the required documents? | DO present, arrival notice present, invoice matched |
| Release readiness | Can the container legally and operationally move? | Customs release confirmed, freight release clear |
| Execution readiness | Can the truck actually pick up? | Appointment confirmed, dispatcher has proof |
...
* Is the shipment file searchable by container number?
* Is the consignee correct across documents?
* Is the broker missing anything?
* Is the drayage provider assigned?
* Is the arrival notice expected or already received?
...
* Customs release status known
* Freight release or payment status known
* Terminal and pickup location verified
* Appointment options reviewed
* LFD captured in the shipment record
...
* Delivery order
* Release status
* Chassis or equipment notes
* Contact for exceptions
* Any hold, exam, payment, or mismatch issue
...
| Capability | What It Helps Teams Do |
| ------------------------------ | ----------------------------------------------------------------------- |
| Shipment document intelligence | Understand which documents matter for each move |
| Missing document detection | See absent delivery orders, arrival notices, releases, or confirmations |
| Container-level document view | Check readiness container by container |
| Document-to-container matching | Link PDFs and emails to the right container |
| Searchable shipment file | Find shipment documents without digging through inboxes |
| Freight exception management | Prioritize blocked shipments before delays grow |
...
* The delivery order is missing or not linked to the container.
* The arrival notice is late or sitting in an individual inbox.
* The broker has not confirmed customs release.
* The appointment confirmation is not attached to the shipment.
* The commercial invoice or packing list has a mismatch.
* The terminal shows availability, but the file does not show release.
* The team has an LFD date but no clear next action.
* The dispatcher is waiting for proof from operations.
* Finance or AP is holding a payment-related release item.
* No one can say which party owns the blocker.
