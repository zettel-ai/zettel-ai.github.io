---
title: What Is Blocking My Shipment? A Framework for Finding Out
slug: what-is-blocking-my-shipment
description: >-
  A practical framework for finding what is blocking a shipment, from document
  status and holds to fees and appointment deadlines.
date: '2026-03-13'
topic: Pickup Readiness
readTime: 14 min read
heroImage:
  src: /images/blog/what-is-blocking-my-shipment/hero.jpg
  alt: Container held at a terminal with a truck waiting
  caption: 'When a shipment stalls, the blocker is usually hiding in the details.'
  credit: U.S. Navy photo by Mass Communication Specialist 3rd Class Chris Lussier
  sourceUrl: >-
    https://commons.wikimedia.org/wiki/File:US_Navy_100204-N-1134L-099_Sailors_assigned_to_Amphibious_Construction_Battalion_(ACB)_2,_remove_a_container_box_blocking_entry_into_their_camp_in_Port-au-Prince,_Haiti.jpg
  license: Public domain
inlineImages:
  - src: /images/blog/what-is-blocking-my-shipment/inline-1.jpg
    alt: Operations team investigating a stalled shipment
    caption: 'A structured scan of documents, holds, and deadlines finds the blocker.'
    credit: CBP Photography
    sourceUrl: >-
      https://commons.wikimedia.org/wiki/File:U_S_Customs_and_Border_Protection_Seattle_Washington_Inspection_(5764585803).jpg
    license: Public domain
diagram:
  src: /diagrams/blog/what-is-blocking-my-shipment.svg
  alt: >-
    Workflow diagram showing a shipment, document status, holds and fees, and
    appointment and last free day data feeding a Zettel blocker scan that
    identifies the blocker and a clear next action
  caption: >-
    How a blocker scan checks documents, holds, fees, and deadlines to identify
    what is blocking a shipment and the next action.
sources:
  ...
  - label: GovDelivery
    url: 'https://content.govdelivery.com/accounts/USDHSCBP/bulletins/12cbeb4'
  - label: Federal Maritime Commission
    url: >-
...
* Carrier release
* Delivery order
* Correct container and bill of lading references
...
| Blocker Type | What It Means | Common Owner |
| ------------------- | ------------------------------------------------ | ------------------------------------- |
| Document blocker | A required file is missing or incomplete | Forwarder, broker, shipper, consignee |
| Customs blocker | Cargo is under review, exam, or document request | Customs broker, importer |
| Release blocker | Carrier or terminal release is not complete | Carrier, terminal, forwarder |
| Appointment blocker | No usable pickup slot exists | Drayage team, terminal |
| Payment blocker | Charges, duties, or invoices are unpaid | Finance, importer |
| Equipment blocker | No chassis or needed equipment is available | Drayage provider, chassis pool |
| Data blocker | Reference numbers do not match | Operations, documentation team |
...
* Bill of lading mismatch
* Required PGA review
* Intensive exam
* Sample request
* Classification issue
* Bond or duty problem
...
* The container becomes available after appointment slots are gone
* The vessel ETA changes and the original appointment no longer works
* Terminal rules change
* A driver misses the gate window
* The pickup appointment is booked under the wrong reference
* The trucker lacks the right release documents
...
* Is carrier release complete?
* Is customs cleared?
* Is an appointment booked?
* Is the appointment tied to the correct container?
* Is there any missing document detection alert?
...
* Original bill of lading not surrendered
* Telex release not confirmed
* Freight charges unpaid
* Carrier hold still active
* Incorrect consignee or notify party
* Missing delivery order
* Mismatched bill of lading number
* Carrier portal not updated
...
* Unpaid terminal charges
* Unpaid carrier charges
* Duties or taxes not funded
...
* No chassis available at the terminal
* Chassis pool shortage
* Chassis split required
* Wrong chassis type
* Equipment out of service
* Extra chassis fees
* Driver unable to secure equipment in time
...
* Wrong bill of lading number
* Wrong booking number
* Incorrect terminal
* Incorrect consignee
* Incorrect seal number
* Incorrect vessel or voyage
* Incorrect pickup number
* Mismatched delivery order
...
* Failed terminal lookup
* Appointment rejection
* Carrier release confusion
* Customs filing delays
* Driver turned away
* Wrong shipment status updates
...
* Which documents are already complete
* Which containers still have document blockers on top of congestion
...
* Which documents belong to which container
* Which document is missing
* Which blocker affects pickup readiness
* Which person or partner likely owns the next action
...
* **Searchable shipment file creation**
* **Container-level document view**
* **Connected shipment record updates**
* **Freight exception management**
* **Pickup readiness review**
...
* What is missing?
* What is blocked?
* Which container does this document affect?
* Who needs to act next?
* Is this shipment pickup ready?
...
| --------------- | -------------------------------------------------------------------------------------- |
| Documents | BOL, DO, arrival notice, invoice, packing list, and required customs files are present |
| Matching | Container, BOL, booking, and pickup references match |
| Customs | CBP release and required PGA messages are resolved |
| Carrier | Carrier release is confirmed |
| Payment | Required charges, duties, or terminal fees are paid or approved |
| Appointment | Pickup appointment is confirmed and tied to the right container |
| Equipment | Chassis or required equipment is available |
| Terminal | Terminal is open, accessible, and accepting the move |
| Ownership | Next action owner is clear |
| Customer update | Customer-facing status reflects the real blocker |
