---
title: The Freight Document Checklist Every Import Team Needs
slug: freight-document-checklist
description: >-
  A working freight document checklist covering the invoices, bills of lading,
  and customs paperwork import teams need to keep shipments moving.
date: '2026-04-22'
topic: Document Management
readTime: 14 min read
heroImage:
  src: /images/blog/freight-document-checklist/hero.jpg
  alt: Checklist and shipping documents on a clipboard
  caption: A reliable checklist turns scattered paperwork into a complete set.
  credit: © Raimond Spekking / CC BY-SA 4.0 (via Wikimedia Commons)
  sourceUrl: >-
    https://commons.wikimedia.org/wiki/File:Cosco_Shipping_Star_-_IMO_9795658_-_moored_at_Container_Terminal_Tollerort,_Hamburg-9361.jpg
  license: CC BY-SA 4.0
inlineImages:
  - src: /images/blog/freight-document-checklist/inline-1.jpg
    alt: Operations desk with documents and a computer
    caption: Validating documents against a checklist surfaces missing items early.
    credit: Trougnouf
    sourceUrl: >-
      https://commons.wikimedia.org/wiki/File:Container_cranes_at_the_MPET-_MSC_PSA_European_Terminal_in_Port_of_Antwerp_(Kieldrecht,_Belgium)_during_the_sunset_civil_twilight_(DSCF3919).jpg
    license: CC BY 4.0
diagram:
  src: /diagrams/blog/freight-document-checklist.svg
  alt: >-
    Workflow diagram showing commercial invoice, packing list, bill of lading,
    and customs paperwork feeding Zettel checklist validation that confirms a
    complete document set or flags missing items
  caption: >-
    How standard freight documents are validated against a checklist to confirm
    a complete set or flag what is missing.
sources:
  ...
  - label: Maersk
    url: >-
      https://www.maersk.com/logistics-explained/shipping-documentation/2023/10/02/what-is-bill-of-lading
  - label: Legal Information Institute
    url: 'https://www.law.cornell.edu/cfr/text/19/142.3'
  - label: eCFR
    url: 'https://www.ecfr.gov/current/title-19/chapter-I/part-141/subpart-F'
  - label: UPS
    url: >-
  ...
  - label: Defense Logistics Agency
    url: >-
      https://www.dla.mil/Small-Business/Resource-Center/Training-Resources/Details/Article/4180121/what-is-proof-of-delivery-pod/
  - label: Federal Maritime Commission
    url: >-
