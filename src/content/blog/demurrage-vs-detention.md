---
title: 'Demurrage vs Detention: What Freight Teams Need to Know'
slug: demurrage-vs-detention
description: >-
  A clear explanation of demurrage, detention, and per diem, the different
  clocks behind them, and how document readiness reduces the risk.
date: '2026-05-04'
topic: Demurrage & Detention
readTime: 12 min read
heroImage:
  src: /images/blog/demurrage-vs-detention/hero.jpg
  alt: Shipping containers stacked at a container terminal
  caption: Demurrage and detention are two different clocks that are easy to confuse.
  credit: 'Guilhem Vellut from Annecy, France'
  sourceUrl: >-
    https://commons.wikimedia.org/wiki/File:Shipping_containers_@_Container_terminal_@_Harbour_Tour_@_Spido_@_Rotterdam_(29935465314).jpg
  license: CC BY 2.0
inlineImages:
  - src: /images/blog/demurrage-vs-detention/inline-1.jpg
    alt: Container train waiting at a rail yard
    caption: Equipment held outside the terminal is where detention and per diem begin.
    credit: ArnoldReinhold
    sourceUrl: >-
      https://commons.wikimedia.org/wiki/File:Filleted_container_train_at_Beacon_Yard.jpg
    license: CC BY-SA 3.0
diagram:
  src: /diagrams/blog/demurrage-vs-detention.svg
  alt: >-
    Diagram contrasting demurrage and detention, with a container inside the
    terminal and carrier equipment in use feeding Zettel free time tracking that
    separates demurrage from detention
  caption: >-
    Demurrage applies to time a container sits at the terminal, while detention
    applies to carrier equipment held outside it.
sources:
